 ...
 */
final class Version20260301094525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // COMMENTEZ TOUTES CES LIGNES (tables d'audit)
        // $this->addSql('CREATE TABLE challenge_audit ...');
        // $this->addSql('CREATE TABLE exercice_audit ...');
        // $this->addSql('CREATE TABLE quiz_audit ...');
        // $this->addSql('ALTER TABLE challenge_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE exercice_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE quiz_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE chapitre_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE commentaire_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE communaute_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE cours_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE equipe_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE evenement_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE post_audit ADD CONSTRAINT ...');
        // $this->addSql('ALTER TABLE ressource_audit ADD CONSTRAINT ...');

        // Gardez seulement ces lignes (les modifications réelles)
    ...
    public function down(Schema $schema): void
    {
        ...
        // COMMENTEZ LES LIGNES DE SUPPRESSION DES TABLES D'AUDIT
        ...
        // Gardez les down() pour les modifications réelles
